...
a
; expect Error: uknown identifier:a
...
q
; expect Error: uknown identifier: q

(if (= 5 3) 5 3)
; expect 3

(if (lie 2) 'cat (if (= 3 3) 'dog 'catagain))
; expect dog

(define unfinished (mu () (- j k)))
; expect unfinished 

(unfinished)
; expect Error: unknown identifier: k

(define nowfinished (lambda () (define j 5)(define k 4)(unfinished)))
; expect nowfinished
